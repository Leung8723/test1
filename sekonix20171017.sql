...
INSERT INTO `sk_ckuser` (`id`, `ck_name`, `create_user`, `create_time`) VALUES
(1, '0', '', 2147483647);
...
INSERT INTO `sk_ctuser` (`id`, `ct_name`, `create_user`, `create_time`) VALUES
...
CREATE TABLE IF NOT EXISTS `sk_temp` (
  ...
  `temp1` float(3,1) NOT NULL,
  `hum1` float(3,1) NOT NULL,
  `temp2` float(3,1) DEFAULT NULL,
  `hum2` float(3,1) DEFAULT NULL,
  `temp3` float(3,1) DEFAULT NULL,
  `hum3` float(3,1) DEFAULT NULL,
  `temp4` float(3,1) DEFAULT NULL,
  `hum4` float(3,1) DEFAULT NULL,
  `temp5` float(3,1) DEFAULT NULL,
  `hum5` float(3,1) DEFAULT NULL,
  `temp6` float(3,1) DEFAULT NULL,
  `hum6` float(3,1) DEFAULT NULL,
  `create_user` varchar(20) NOT NULL,
  `create_time` int(10) NOT NULL,
  `update_time` int(10) DEFAULT NULL,
  `status` tinyint(1) NOT NULL,
