        ...
        <div class="col-lg-6">
          <form class="form-horizontal" id="singcms-form">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" name="model" class="form-control" id="inputname" placeholder="请填写型号全称" value="<?php echo ($lens["model"]); ?>">
              </div>
            </div>
            <div class="form-group">
              <label for="inputname" class="col-sm-2 control-label">规格:</label>
              <div class="col-sm-5">
                <input type="text" name="specs" class="form-control" id="inputname" placeholder="请填写每板镜片数量" value="<?php echo ($lens["specs"]); ?>">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="color">
                  <option value="<?php echo ($lens["color"]); ?>">==请选择色相基准==</option>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="material">
					<option value="<?php echo ($lens["material"]); ?>">==请选择镜片材质==</option>
